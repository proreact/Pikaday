...
(function (root, factory) {
    ...
    var hasMoment = typeof moment === "function",
        ...
        renderDay = function (opts) {
            ...
            return (
                ...
                ariaSelected +
                '"' +
                (opts.isEmpty ? 'role="presentation"' : "") +
                ">" +
        ...
        renderTitle = function (instance, c, year, month, refYear, randId) {
            var i,
                ...
                html =
                    '<div id="' +
                    randId +
                    '" class="pika-title" aria-live="assertive" aria-atomic="true">',
                monthHtml,
                yearHtml,
                prev = true,
                next = true;
            ...
            monthHtml =
                ...
                '<select class="pika-select pika-select-month" tabindex="-1" aria-label="' +
                opts.i18n.selectMonth +
                '">' +
                arr.join("") +
                "</select></div>";
            ...
            yearHtml =
                ...
                year +
                opts.yearSuffix +
                '<select class="pika-select pika-select-year" tabindex="-1" aria-label="' +
                opts.i18n.selectYear +
                '">' +
                arr.join("") +
                "</select></div>";
        ...
        renderTable = function (opts, data, randId) {
            return (
                '<table class="pika-table" role="grid" aria-label="' +
                opts.i18n.selectDate +
                '">' +
                renderHead(opts) +
                renderBody(data) +
                "</table>"
        ...
        Pikaday = function (options) {
            ...
            addEvent(self.el, "keydown", self._onMouseDown, true);
    ...
    Pikaday.prototype = {
        ...
        config: function (options) {
            ...
            opts.theme =
                typeof opts.theme === "string" && opts.theme
                    ? opts.theme
                    : null;
            ...
            if (isArray(opts.yearRange)) {
                ...
                opts.yearRange =
                    Math.abs(parseInt(opts.yearRange, 10)) ||
                    defaults.yearRange;
        ...
        setDate: function (date, preventOnSelect) {
            ...
            if (this._o.field) {
                ...
                debouncedFireEvent(this._o.field, "change", { firedBy: this });
            }
        ...
        adjustPosition: function () {
            ...
            if (
                (this._o.reposition &&
                    top + height > viewportHeight + scrollTop) ||
            ...
            removeClass(
                this.el,
                !leftAligned ? "left-aligned" : "right-aligned"
            );
            removeClass(
                this.el,
        ...
        render: function (year, month, randId) {
            ...
            for (var i = 0, r = 0; i < cells; i++) {
                var day = new Date(year, month, 1 + (i - before)),
                    ...
                    hasEvent =
                        opts.events.indexOf(day.toDateString()) !== -1
                            ? true
                            : false,
        ...
        destroy: function () {
            ...
            removeEvent(this.el, "keydown", this._onMouseDown, true);
